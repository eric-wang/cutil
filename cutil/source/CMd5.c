...
/* MD5 block update operation. Continues an MD5 message-digest
  ...
  context.
 */
void MD5UpdateImp (context, input, inputLen)
MD5_CONTEXT *context;                                        /* context */
 ...
 */
void MD5FinalImp (digest, context)
...
*/
  ...
  MD5UpdateImp (context, PADDING, padLen);

  /* Append length (before padding) */
  MD5UpdateImp (context, bits, 8);
