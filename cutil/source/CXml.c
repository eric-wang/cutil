 ...
 ****************************************************************************
 */
void McbInitElement(McbXMLElement *pEntry, McbXMLElement *pParent, LPTSTR lpszName, int nIsDeclaration)
{
	assert(pEntry);
...
McbXMLElement * McbCreateRoot()
{
	...
	pElement = (McbXMLElement*)balloc(sizeof(McbXMLElement));
...
void McbDeleteAttribute(McbXMLAttribute *pEntry)
{
	...
	if (pEntry->lpszName) 
	{
		bfree(pEntry->lpszName);
		pEntry->lpszName = NULL;
	}

	if (pEntry->lpszValue) 
	{
		bfree(pEntry->lpszValue);
...
LPTSTR McbStrdup(LPCTSTR lpszData, int cbData)
{
	...
	lpszNew = balloc((cbData+1) * sizeof(TCHAR));
	...
	if (ch)
	{
        ...
        */
		...
		case ('\"'):
            ...
            *****************************************************************
            */
			while(0 != (ch = McbGetNextChar(pXML)))
			{
				nSize++;
...
void McbAllocNodes(McbXMLElement *pEntry, int nGrowBy)
{
    ...
    */
    ...
    pNew = balloc(sizeof(McbXMLNode) * nMax);
							 ...
							 int nIsDeclaration, int nGrowBy)
{
    ...
    */
	...
	pElement = balloc(sizeof(McbXMLElement));
					...
					LPTSTR lpszValue, int nGrowBy)
{
    ...
    */
	...
	pAttr = balloc(sizeof(McbXMLAttribute));
...
McbXMLText * McbAddText(McbXMLElement *pEntry, LPTSTR lpszValue, int nGrowBy)
{
    ...
    */
	...
	pText = balloc(sizeof(McbXMLText));
						...
						McbClearTag *pClear, int nGrowBy)
{
    ...
    */
	...
	pNewClear = balloc(sizeof(McbXMLClear));
...
McbXMLElement * McbFindElement(McbXMLElement *pEntry, LPCTSTR lpszPath)
{
    ...
    */
	...
	if (0 != cbName)
	{
        ...
        */
        nIndex = 0;
        while(NULL != (pChild = McbEnumElements(pEntry, &nIndex)))
        {
           /*
            *****************************************************************
...
McbXMLAttribute * McbFindAttribute(McbXMLElement *pEntry, LPCTSTR lpszAttrib)
{
	...
	while(NULL != (pAttr = McbEnumAttributes(pEntry, &nIndex)))
	{
...
McbXMLElement * McbCreateElements(McbXMLElement *pEntry, LPCTSTR lpszPath)
{
    ...
    */
	...
	if (0 != cbName)
	{
        ...
        *********************************************************************
        */
		pNew = McbAddElement(pEntry, McbStrdup(lpszPath, cbName), FALSE, McbGROWBY);
...
#define McbLENSTR(lpsz) (lpsz ? _tcslen(lpsz) : 0)
    ...
    */
	...
	if (cbElement)
	{
        ...
        */
        nIndex = 0;
        while (NULL != (pChild = McbEnumNodes(pEntry, &nIndex)))
        {
            switch(pChild->type)
            {
           /*
...
LPTSTR McbCreateXMLString(McbXMLElement * pHead, int nFormat, int *pnSize)
{
	...
	if (pHead)
	{
        ...
        *********************************************************************
        */
		lpszResult = (LPTSTR)balloc(cbStr+1);
